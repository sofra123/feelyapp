              ...
              messages.map((msg, id) => {
                return (
                  <div className="msg" key={id}>
                    <img src={msg.url || "images/avatar.jpg"} />
                    <div className="messages">
                      <span className="chat-names">
                        {msg.first} {msg.last}{" "}
                        <Moment fromNow>{msg.created_at}</Moment> says :
                      </span>
                      {msg.message}
                    </div>
                  </div>
        ...
        <div className="online-container">
          ...
          {onlineUsers &&
            onlineUsers.map(listOfUsersOnline => {
              return (
                <div className="friendsonline" key={listOfUsersOnline.id}>
                  <img src={listOfUsersOnline.url || "images/avatar.jpg"} />
                  <p className="friendname">
                    {listOfUsersOnline.first} {listOfUsersOnline.last}
                  </p>
                </div>
              );
            })}
